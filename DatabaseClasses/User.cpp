...
User::User(std::string userID, std::string firstName, std::string lastName, std::time_t birthDate,
           const std::string &country, std::string stateProvince, std::vector<std::string> friends) {
...
void User::updateInDatabase(sql::Connection &con) {
    ...
    if (!this->stateProvince.empty()) {
        query = "UPDATE users SET first_name = " + this->firstName + ", last_name = " + this->lastName + ", birth_date = " + birthDate.str() + ", stateProvince = " + this->stateProvince +
                ", country = " + this->country + " WHERE user_id = " + this->userID;
    } else {
        query = "UPDATE users SET first_name = " + this->firstName + ", last_name = " + this->lastName + ", birth_date = " + birthDate.str() + ", country = " + this->country +
